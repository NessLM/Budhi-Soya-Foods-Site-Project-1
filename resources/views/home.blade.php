...
<head>
  ...
  <meta name="description"
    content="Budhi Soya Foods menyediakan produk soya berkualitas tinggi, organik, dan bergizi untuk gaya hidup sehat Anda.">
  ...
  <section class="hero-section">
    <div class="hero-section-item">
      <div class="hero-section-content">
        ...
        <p>Bergizi, organik, dan dibuat secara lokal dengan penuh cinta. Mulailah gaya hidup sehatmu bersama produk soya
          berkualitas tinggi kami.</p>
        @auth
      ...
      <div class="product-section">
        <div class="product-slider">
          ...
          <div class="product-image-container">
            <img id="product-image" src="{{ asset('uploads/products/' . $products->first()->foto) }}"
            alt="{{ $products->first()->nama_produk }}" loading="lazy">
        ...
        @endauth
          ...
          <button class="dot {{ $index === 0 ? 'active' : '' }}" data-slide="{{ $index }}"
    ...
    <div class="container">
      <div class="recommendation-grid">
        <div class="recommendation-content">
          ...
          <p class="recommendation-desc">Temukan berbagai produk soya berkualitas tinggi yang telah dipilih khusus untuk
            memenuhi kebutuhan gizi harian Anda. Dari tempe segar hingga susu kedelai murni, semua dibuat dengan standar
            kualitas terbaik.</p>
          @auth
    ...
    <div class="container">
      <div class="popular-grid">
        ...
        <div class="popular-content">
          ...
          <p class="popular-desc">Jelajahi koleksi lengkap produk soya kami yang telah terbukti menjadi favorit
            pelanggan. Setiap produk dibuat dengan resep tradisional yang telah diwariskan turun-temurun.</p>
          @auth
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-col">
          <h3>Budhi Soya Foods</h3>
          <p>Menyediakan produk soya berkualitas tinggi untuk gaya hidup sehat Anda. Dipercaya sejak bertahun-tahun
            sebagai produsen makanan sehat terbaik.</p>
